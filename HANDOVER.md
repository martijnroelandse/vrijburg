...
- **Foto upload** ✅ *geïmplementeerd* — JPEG/PNG/WebP upload, verkleind tot max. 900px, ingebed in het .docx op de voorkant. Niet mee in gedeelde links (te groot); wel bewaard in localStorage-concept. Voor vrijburg.nl: foto downloaden en handmatig in WordPress uploaden (GitHub Pages is statisch — geen server-side upload mogelijk).
